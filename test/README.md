...
> **Note:** `step-ca`, `influxdb2`, `mock-auth` and `spa-backend` are not exposed on the host by default — they communicate over the internal `layer8-smoke` Docker network.
