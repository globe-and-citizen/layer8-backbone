...
pub const MOCK_SHARED_SECRET_2: [u8; 16] = [
    226, 186, 202, 159, 51, 31, 151, 34, 174, 233, 128, 164, 202, 226, 146, 91,
];
/// api GET /me
#[allow(dead_code)]
pub const MOCK_PROXY_REQUEST_BODY_1: [u8; 80] = [
    159, 207, 157, 116, 32, 92, 248, 78, 122, 253, 236, 125, 67, 223, 157, 30, 30, 45, 49, 165,
    234, 211, 72, 242, 252, 31, 128, 60, 245, 158, 182, 126, 117, 152, 232, 172, 52, 155, 246, 122,
    86, 89, 78, 162, 110, 171, 73, 84, 127, 41, 195, 46, 85, 31, 71, 121, 234, 63, 27, 236, 43,
    190, 186, 124, 94, 212, 238, 13, 254, 32, 147, 59, 239, 30, 176, 138, 54, 167, 161, 132,
];
/// api GET /profile/test
#[allow(dead_code)]
pub const MOCK_PROXY_REQUEST_BODY_2: [u8; 90] = [
    210, 33, 207, 169, 246, 8, 233, 118, 37, 197, 180, 162, 77, 165, 168, 70, 128, 112, 244, 122,
    187, 27, 188, 245, 126, 167, 152, 194, 233, 6, 37, 95, 101, 101, 247, 243, 37, 221, 51, 101,
    23, 95, 2, 28, 123, 161, 251, 79, 193, 18, 75, 19, 204, 130, 106, 149, 30, 170, 91, 8, 218, 17,
    212, 12, 130, 29, 187, 109, 187, 30, 42, 25, 187, 152, 171, 75, 78, 99, 74, 47, 61, 196, 224,
    108, 107, 217, 220, 32, 187, 70,
];
