...
pub const MOCK_NTOR_CLIENT_PUBLIC_KEY: [u8; 32] = [157, 192, 124, 16, 87, 35, 182, 121, 125, 166, 205, 87, 89, 15, 158, 42, 84, 193, 173, 211, 155, 177, 32, 217, 51, 204, 79, 44, 189, 176, 79, 21];
pub const MOCK_NTOR_SERVER_EPHEMERAL_PUBLIC_KEY: [u8; 32] = [237, 12, 46, 100, 252, 26, 102, 19, 73, 40, 204, 185, 16, 72, 199, 57, 60, 89, 105, 239, 164, 255, 209, 100, 250, 41, 246, 157, 7, 121, 221, 111];
pub const MOCK_NTOR_SERVER_T_B_HASH: [u8; 32] = [175, 53, 72, 226, 127, 62, 62, 121, 255, 198, 133, 168, 224, 43, 81, 172, 32, 138, 194, 200, 165, 61, 48, 18, 73, 199, 122, 117, 93, 173, 143, 59];
pub const MOCK_NTOR_SERVER_STATIC_PUBLIC_KEY: [u8; 32] = [131, 210, 36, 101, 39, 191, 61, 165, 29, 112, 94, 149, 120, 202, 189, 170, 151, 62, 247, 71, 208, 255, 144, 173, 52, 223, 239, 221, 153, 225, 40, 10];
...
pub const MOCK_PROXY_REQUEST_DATA: &[u8] = b"Hello, this is a test message from the client to the backend through the forward proxy.";
